...
<head>
    ...
    <title>Konfirmasi Password — Taichan POS</title>
...
<body>
    <div class="wrap">
        ...
        <div class="card">
            <p class="card-title">Konfirmasi Password</p>
            <p class="card-desc">Area ini memerlukan konfirmasi password sebelum melanjutkan.</p>
